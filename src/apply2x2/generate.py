...
def createExamples(dataset, op_types, number_of_examples, filename):
    ...
    with open(filename, 'w') as f:
        ...
        while example_index < number_of_examples:
            ...
            f.write(
                'digit1={},digit2={},digit3={},op11_image={},op12_image={},op21_image={},op22_image={},row1_result={},row2_result={},col1_result={},col2_result={}\n'. \
                    format(digit1, digit2, digit3, op1_index, op2_index, op3_index, op4_index, row1_result, row2_result,
