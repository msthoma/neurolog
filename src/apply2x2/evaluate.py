...
from src.apply2x2.manager import Apply2x2Example
...
class Evaluator(object):
    ...
    def evaluate(self, facts: List[str], target: Apply2x2Example) -> bool:
        ...
        if row1_result == target.label[0] and row2_result == target.label[1] and col1_result == target.label[
            2] and col2_result == target.label[3]:
            return True
