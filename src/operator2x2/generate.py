...
def createExamples(dataset, number_of_examples, filename):
    ...
    with open(filename, 'w') as f:
        ...
        while example_index < number_of_examples:
            ...
            f.write(
                'digit11_image={},digit12_image={},digit21_image={},digit22_image={},row1_result={},row2_result={},col1_result={},col2_result={}\n'.format(
                    image1_index, image2_index, image3_index, image4_index, digit1 - digit2, digit3 + digit4,
