...
from src.benchmark_manager import BenchmarkManager, Example


class Tester(object):

    def __init__(self, network: nn.Module, outputClasses: List, benchmarkManager: BenchmarkManager,
                 translator: AbstractTranslator, evaluator):
