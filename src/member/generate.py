...
createExamples(dataset=mnist_train_data, number_of_examples=100000, number_of_arguments=5,
               filename=data_root + "memberOf/5/train_data.txt")
createExamples(dataset=mnist_test_data, number_of_examples=100000, number_of_arguments=5,
               filename=data_root + "memberOf/5/test_data.txt")
